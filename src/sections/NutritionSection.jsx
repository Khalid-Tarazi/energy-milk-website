...
const NutritionSection = ({ isReady }) => {
  ...
  useEffect(() => {
    ...
    const paragraphSplit = new SplitText(".nutrition-section p", {
      type: "words, lines",
      linesClass: "paragraph-line",
    });

    // Timeline for title & paragraph
    ...
    // Timeline for nutrition-text-scroll reveal
